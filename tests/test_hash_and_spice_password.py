...
def test_salt_password() -> None:
    ...
    assert salted_password == password + salt, (
        'Salted password does not match expected value'
    )
...
def test_pepper_password() -> None:
    ...
    assert peppered_password == password + PEPPER, (
        'Peppered password does not match expected value'
    )
...
def test_hash_password() -> None:
    ...
    assert hashed_password == expected_hash, (
        'Hashed password does not match expected hash'
    )
